...
CASE_MAP = {'0':'0', "3": "C5449", "4": "C4672", "5": "C2579", "6": "C1701", "7": "C3299", "8": "C5508", "9": "C7483",
            "10": "C6244",
...
def select_location(title):
    ...
    # Return the selected path (or None if no directory was selected)
    return path
