...
#
def measure_bone_distance(seg_images, roi_images, pa_index, ch_index, spacing, thickness, save_path, hu_scale = True):
    """
...
def imshow_axail_bone_distance(images, bone_distance_data, bone_distance_data_more ):
    ...
    if min_width < 11:
        ...
        title += "\nThe Narrowest PA width found is: " + str(min_width) + "\n CNPAS Detected (< 11mm)"
    else:

        title += "\n Normal PA width (> 11mm) "
